...
Una vez introducidos introducidos todos los datos y seleccionados los parámetros deseados para la simulación se debe hacer click en el botón CALCULAR Y GRAFICAR de la parte inferior. Con esto comenzará a ejecutarse el programa y al finalizar se abrirá una pestaña con todos los resultados gráficados.
